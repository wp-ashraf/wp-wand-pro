...
module.exports = {
    ...defaultConfig,
    entry: {
        bulk: path.resolve(__dirname, 'assets/src/apps/bulk/index.js'),
        automation: path.resolve(__dirname, 'assets/src/apps/automation/index.js'),
        license: path.resolve(__dirname, 'assets/src/apps/license/index.js'),
        seo: path.resolve(__dirname, 'assets/src/apps/seo/index.js'),
        woocommerce: path.resolve(__dirname, 'assets/src/apps/woocommerce/index.js'),
    },
    output: {
