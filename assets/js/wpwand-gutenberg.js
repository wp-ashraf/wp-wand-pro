        ...
        401: () => {
            ...
            async function c() {
                    ...
                    let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "below",
                        ...
                        s = '<span id="' + (Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15)) + '" class="wpwand-editor-loading">Loading...</span>';
                    ...
                    edit: e => {
                        ...
                        if ("object" == typeof wpwand_gutenberg_editor && "object" == typeof wpwand_gutenberg_editor.editor_menus) {
                            ...
                            for (let e = 0; e < wpwand_gutenberg_editor.editor_menus.length; e++) {
                                ...
                                void 0 !== o.name && "" !== o.name && void 0 !== o.prompt && "" !== o.prompt && s.push({
                                    title: o.name,
                                    onClick: async () => {
                                        const e = d();
                                        if (e) {
